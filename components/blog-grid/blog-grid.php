...
<section class="ll-blog-grid <?php echo implode( " ", $classes ); ?>"<?php echo ' id="'.$id.'"'; ?> data-component="blog-grid">
  ...
  ?>
      ...
      <div class="blog-grid__blog_wrapper card__wrapper col-sm-6of12 col-md-6of12 col-lg-6of12 col-xl-6of12" data-terms="<?php echo implode(' ', $cat_list); ?>">
        ...
        <?php endif; ?>
          ...
          <time class="blog-grid__blog__meta published" datetime="<?php echo get_the_time('c'); ?>"><?php echo get_the_date(); ?></time>
          ...
          <div class="blog-grid__blog__nav row between">
