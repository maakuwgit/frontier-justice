...
function ll_get_social_list($echo=true) {
  ...
  $social_media_sites = array(
    'instagram' => array(
      'slug'  => 'instagram_fashion',
      'url'   => get_field( 'social_instagram', 'option' ),
      'title' => 'Fashion Instagram'
    ),
    'instagram_2' => array(
      'slug'  => 'instagram_store',
      'url'   => get_field( 'social_instagram_2', 'option' ),
  ...
  if ( $social_media_sites ) {
    $str = '<ul class="social-list">';
      foreach ( $social_media_sites as $social ) {
        ...
        if( $social['url'] ) {
          $str .= '<li class="social-list__item"><a class="social-list__link '.$social['slug'].'" href="'.$social['url'].'" target="_blank">' . $social['title'].'</a></li>';
        }
      }
