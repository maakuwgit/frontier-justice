...
function ll_get_logo( $variation='default' ) {
  switch( $variation ) {
    case 'graphic':
      $logo = '<img alt="' . get_bloginfo('name') . '" src="'.get_template_directory_uri() . '/assets/img/logo_graphic_only.png">';
    break;
    case 'text':
      $logo = '<img alt="' . get_bloginfo('name') . '" src="'.get_template_directory_uri() . '/assets/img/logo_text_only.png">';
    break;
    case 'member':
      $logo = '<img alt="' . get_bloginfo('name') . ':Member Perks Avialable" src="'.get_template_directory_uri() . '/assets/img/logo_member.png">';
    break;
    default:
      $logo = '<img alt="' . get_bloginfo('name') . '" src="'.get_template_directory_uri() . '/assets/img/logo.png">';
    break;
  }
